    ...
    "Apparel": {
        ...
        "children": [
            ...
            },
            {
                "label": "Workwear",
                "children": [
                    { "label": "Military & Police Gear" },
                    { "label": "Uniforms & Tactical Gear" },
                    { "label": "Firefighter Gear" },
                    { "label": "Scrubs & Medical Uniforms" },
                    { "label": "Job Uniforms" }
                ]
            }
        ]
        ...
        "children": [
            ...
            },
            {
                ...
                "children": [
                    ...
                    { "label": "Body Makeup" },
                    { "label": "Face Makeup" },
                    { "label": "Makeup Accessories & Organizers" },
                    { "label": "Lip Makeup" }
                ]
            },
            {
...
new Vue({
    ...
    methods: {
        ...
        submit() {
            let temp = "/category?page=" + this.page + '&size=' + this.pageSize+'&category=' + this.radio + '&subCategory=' + this.cate;
    ...
    mounted() {
        ...
        let map = {"Apparel": 49997, "Beauty": 14833, "Electronics": 9453, "Health": 28251, "Home": 59003, "Money": 7274, "Places & Travel": 13860, "Software": 29652};
        if(radio && radio in map) {
            this.radio = radio;
            if(cate && cate!='') {
                axios.get('/brand/cate/' + cate + '/1/1').then(res => {
                    if(res.data.count != 0) {
            ...
            this.treeData = [];
            this.treeData.push(category[radio]);
        } else {
            this.radio = 'Apparel';
            this.total = 49997
            this.treeData = [];
            this.treeData.push(category['Apparel']);
        }
    }
})
